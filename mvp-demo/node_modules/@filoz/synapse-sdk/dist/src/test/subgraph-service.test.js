...
const TEST_CONSTANTS = {
    ...
    MOCK_PIECE_CID: asPieceCID('bafkzcibcoybm2jlqsbekq6uluyl7xm5ffemw7iuzni5ez3a27iwy4qu3ssebqdq'),
    MOCK_ADDRESS: '0x123',
    MOCK_PRODUCT_DATA: '{"serviceURL": "https://calib.ezpdpz.net", "minPieceSizeInBytes": "1024", "maxPieceSizeInBytes": "34359738368", "ipniPiece": "false", "ipniIpfs": "false", "storagePricePerTibPerMonth": "1000000", "minProvingPeriodInEpochs": "30", "location": "unknown", "paymentTokenAddress": ""}',
};
...
function createMockPiece(overrides = {}) {
    return {
        id: 'piece-1',
        setId: '1',
        pieceId: '1',
...
function createMockFaultRecord(overrides = {}) {
    return {
        id: 'fault-1',
        dataSetId: '1',
        pieceIds: ['1', '2'],
...
async function withMockFetch(responses, testFn) {
...
async function expectError(testFn, expectedPattern, message = 'should have thrown') {
    try {
        await testFn();
        assert.fail(message);
    }
    catch (err) {
        assert.match(err.message, expectedPattern);
    }
}
describe('SubgraphService', () => {
    ...
    describe('getApprovedProvidersForPieceCID', () => {
        ...
        it('should handle GraphQL errors', async () => {
            ...
            await expectError(() => withMockFetch({ default: mockResponse }, async () => {
                const service = new SubgraphService({ endpoint: TEST_CONSTANTS.MOCK_ENDPOINT });
