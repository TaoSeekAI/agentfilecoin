...
import { EIP712_ENCODED_TYPES, EIP712_TYPE_HASHES } from "../utils/eip712.js";
describe('EIP712 Type String Generator', () => {
    it('should generate correct type string for nested type', () => {
        ...
        const expected = 'AddPieces(uint256 clientDataSetId,uint256 firstAdded,Cid[] pieceData,PieceMetadata[] pieceMetadata)Cid(bytes data)MetadataEntry(string key,string value)PieceMetadata(uint256 pieceIndex,MetadataEntry[] metadata)';
