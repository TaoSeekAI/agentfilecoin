...
import { PDP_PERMISSIONS } from "../session/key.js";
import { Synapse } from "../synapse.js";
import { makeDataSetCreatedLog } from "./mocks/events.js";
import { ADDRESSES, JSONRPC, PRIVATE_KEYS, presets } from "./mocks/jsonrpc/index.js";
import { createDataSetHandler, dataSetCreationStatusHandler } from "./mocks/pdp/handlers.js";
import { PING } from "./mocks/ping.js";
const server = setup([]);
describe('Synapse', () => {
    let signer;
    let provider;
    ...
    describe('Session Keys', () => {
        ...
        beforeEach(() => {
            ...
            server.use(dataSetCreationStatusHandler(FAKE_TX_HASH, {
                ok: true,
    ...
    describe('download', () => {
        ...
        it('should pass withCDN option to retriever', async () => {
            ...
            const testData = new TextEncoder().encode('test data');
            server.use(JSONRPC({ ...presets.basic }), http.get(`https://:wallet.calibration.filbeam.io/:cid`, async ({ params }) => {
