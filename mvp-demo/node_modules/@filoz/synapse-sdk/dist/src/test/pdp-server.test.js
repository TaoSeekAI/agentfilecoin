...
describe('PDPServer', () => {
    ...
    describe('createDataSet', () => {
        it('should handle successful data set creation', async () => {
            ...
            const result = await pdpServer.createDataSet(0, '0x70997970C51812dc3A010C7d01b50e0d17dc79C8', await signer.getAddress(), [], TEST_CONTRACT_ADDRESS);
    ...
    describe('deletePiece', () => {
        it('should handle successful delete', async () => {
            ...
            server.use(http.delete('http://pdp.local/pdp/data-sets/1/pieces/2', async ({ request }) => {
                const body = await request.json();
        ...
        it('should handle server errors', async () => {
            server.use(http.delete('http://pdp.local/pdp/data-sets/1/pieces/2', async () => {
                return HttpResponse.text('Database error', {
                    status: 500,
                });
            }));
    ...
    describe('getPieceStatus', () => {
        it('should successfully get piece status', async () => {
            ...
            server.use(http.get('http://pdp.local/pdp/piece/:pieceCid/status', async () => {
                return HttpResponse.json(mockResponse, {
                    status: 200,
                });
            }));
